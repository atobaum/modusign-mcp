...
export function registerDocumentTools(server: McpServer, client: ModusignClient): void {
  ...
  server.tool(
    'document_create',
    'Create a new signing request with a PDF file. Provide file as base64 or use fileId+token from file_upload. 새 서명 요청을 생성합니다. PDF 파일을 base64로 전달하거나 file_upload 결과의 fileId+token을 사용합니다.',
    {
